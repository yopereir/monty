...
assistant_fallback_task_actions = {
    'actions': [
        {'say': '''Sorry, I haven\'t learned that yet. But maybe I couldn\'t hear you clearly. Could you say that again?'''},
        {'listen': True}
    ]
}
...
task = client.autopilot.assistants('UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX') \
                       .tasks \
                       .create(
                           unique_name='assistant_fallback',
                           actions=assistant_fallback_task_actions)
