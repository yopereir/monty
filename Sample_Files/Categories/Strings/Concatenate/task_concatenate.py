...
concatenate_task_actions = {
    'actions': [
        {'say': '''Concatenation is used to combine strings. You can concatenate by using a plus sign between each string.'''},
        {'listen': True}
    ]
}
...
task = client.autopilot.assistants('UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX') \
                       .tasks \
                       .create(
                           unique_name='concatenate',
                           actions=concatenate_task_actions)
