...
assistant_greeting_task_actions = {
    'actions': [
        {'say': '''Hi, I\'m Monty and I\'m learning Python. My skills improve as I continue to learn. 
        Ask me your Python questions to see if I can help you out.'''},
        {'listen': True}
    ]
}
...
task = client.autopilot.assistants('UAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX') \
                       .tasks \
                       .create(
                           unique_name='assistant_greeting',
                           actions=assistant_greeting_task_actions)
